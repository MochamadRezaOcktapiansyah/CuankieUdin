...
@section('title','Cuanki Mas Udin || HOME PAGE')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <!-- Start Single List  -->
                @foreach($product_lists as $product)
                    @if($product->condition=='top-viewed')
                        <div class="single-list">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="list-image overlay">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <div class="input-group">
                                                <div class="button minus">
                                                    <button type="button" class="btn btn-primary btn-number" disabled="disabled" data-type="minus" data-field="quantity[1]">
                                                        <i class="ti-minus"></i>
                                                    </button>
                                                </div>
                                                <input type="hidden" name="slug" value="{{$product->slug}}">
                                                <input type="text" name="quantity[1]" class="input-number"  data-min="1" data-max="1000" value="1">
